            ...
            <div class="row space-top">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control valid ${findHasError(error, 'make')}" id="new-make" type="text" name="make">
                    </div>
                    ...
                    <div class="form-group has-danger">
                        ...
                        <input class="form-control is-invalid ${findHasError(error, 'year')}" id="new-year" type="number" name="year">
                    </div>
                    <div class="form-group">
